...
from qfluentwidgets import (
    ScrollArea, PushButton, ToolButton, FluentIcon, isDarkTheme, Theme, ToolTipFilter)
...
class ExampleCard(QWidget):
    ...
    def __init__(self, title, widget: QWidget, stretch=0, parent=None):  # sourcePath
        super().__init__(parent=parent)
        self.widget = widget
    ...
    def __initLayout(self):
        ...
        self.bottomLayout.setAlignment(Qt.AlignRight | Qt.AlignRight)
...
class GalleryInterface(ScrollArea):
    ...
    def addExampleCard(self, title, widget, stretch=0):  # sourcePath: str,
        card = ExampleCard(title, widget, stretch, self.view)  # sourcePath,
